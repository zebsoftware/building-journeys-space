  ...
  head: () => ({
    meta: [
      ...
      { title: "The Founder — Everyone is building something" },
      {
        name: "description",
        content:
          "A community of writers sharing stories, journeys, ideas, creativity and lessons from the middle of the work.",
      },
      { name: "author", content: "The Founder" },
      { property: "og:title", content: "The Founder — Everyone is building something" },
      {
        property: "og:description",
        content: "Stories, journeys, ideas, creativity and growth from people building in public.",
      },
